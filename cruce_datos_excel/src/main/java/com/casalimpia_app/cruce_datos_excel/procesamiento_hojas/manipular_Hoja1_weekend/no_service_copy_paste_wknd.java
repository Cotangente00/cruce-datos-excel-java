 ...
 */
package com.casalimpia_app.cruce_datos_excel.procesamiento_hojas.manipular_Hoja1_weekend;
 ...
 * @author jcavilaa
 */
public class no_service_copy_paste_wknd {
    public static void copiarFilas_wknd(Workbook wb) throws Exception {
        ...
        for (int i = primeraFilaHoja1; i <= wsHoja1.getLastRowNum(); i++) {
            ...
            if (filaHoja1 != null) {
                ...
                Cell celdaG = filaHoja1.getCell(6);  // Columna G es el índice 6
                ...
                if (celdaG.getNumericCellValue() == 240 || celdaG.getNumericCellValue() == 235 || celdaG.getNumericCellValue() == 120) {
