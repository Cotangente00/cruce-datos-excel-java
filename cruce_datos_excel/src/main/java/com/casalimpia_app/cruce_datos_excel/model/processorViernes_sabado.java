...
import com.casalimpia_app.cruce_datos_excel.procesamiento_hojas.manipular_Hoja1.*;
import com.casalimpia_app.cruce_datos_excel.procesamiento_hojas.manipular_Hoja1_weekend.*;
import com.casalimpia_app.cruce_datos_excel.procesamiento_hojas.manipular_INFORME_SOLICITUDES.*;
import com.casalimpia_app.cruce_datos_excel.procesamiento_hojas.maquillaje.*;
 ...
 * @author jcavilaa
 */
public class processorViernes_sabado {
        public static void viernes_sabado(String inputFilePath, String outputFilePath) throws Exception {
        try {
            ...
            find_table_wknd.encontrar_tabla_wknd(wb);
            concatenar_nombres_apellidos_wknd.concatenacion_wknd(wb);
            ...
            if (inputFilePath.endsWith(".xls")) {
                try (FileOutputStream fos = new FileOutputStream(outputFilePath)) {
                    ...
                    outputWorkbook.write(fos);  // Guardar el nuevo archivo en formato XLSX
                ...
                no_service_copy_paste_wknd.copiarFilas_wknd(wb2);
                horizontal_column_size_wknd.ajustarAnchoColumnas_wknd(wb2);
                ...
                no_service_copy_paste_wknd.copiarFilas_wknd(wb);
                horizontal_column_size_wknd.ajustarAnchoColumnas_wknd(wb);
    ...
    public static void main(String[] args) {
        String inputFilePath = "O:/aa/test-viernes-sabado.xls";
        String outputFilePath = "O:/aa/result-wknd.xlsx";
        try {
            viernes_sabado(inputFilePath, outputFilePath);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
