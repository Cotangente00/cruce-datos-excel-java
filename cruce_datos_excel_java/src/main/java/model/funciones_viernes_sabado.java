...
import java.io.*;
import procesamiento_hojas.manipular_Hoja1.*;
import procesamiento_hojas.manipular_INFORME_SOLICITUDES.*;
import procesamiento_hojas.maquillaje.*;
import procesamiento_hojas.manipular_Hoja1_weekend.*;
...
public class funciones_viernes_sabado {
